...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Welcome | Tour Buddy</title>
                ...
                <nav class="navbar navbar-default">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="signin.jsp"><font size="3">Sign In/ Register</font></a></li>
                            </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 section-heading text-center">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-md-offset-2 subtext single-animate animate-press-2">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="box to-animate" style="height:550px">
                    <a href="hotelCategory1.jsp"><div class="icon colored-1"><span><img src="images/lbh.jpg" style="width:270px;height:270px"/></span></div></a>
